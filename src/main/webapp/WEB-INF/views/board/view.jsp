	...
	<div class="container comment-section">
		...
		<c:forEach var="comment" items="${commentList}">
				...
				<c:if test="${board.userId == userId}">
					<a class="btn btn-edit" href="${pageContext.request.contextPath}/board/updateComment?id=${comment.id}"><small>수정</small></a>
					<a class="btn btn-delete" href="${pageContext.request.contextPath}/board/deleteComment?id=${comment.id}"><small>삭제</small></a>
				</c:if>
				</form>
				</div>
		</c:forEach>
